...
ipAdresimiAl().then(function () {
  ...
  axios.get(url).then(function (response) {
    var ipDinamik = response.data;
    var cardes = cardOlustur(ipDinamik);
...
function cardOlustur(data) {
  ...
  var ulkeImg = document.createElement("img");
  if (ulkeImg.img) {
  ...
  var ipH3 = document.createElement("h3");
